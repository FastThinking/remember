...
public class RxPermissions {
    ...
    public ObservableTransformer<String, Boolean> ensure(final String... permissions) {
        return upstream ->
                request(upstream, permissions)
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public ObservableTransformer<String, Permission> ensureEach(final String... permissions) {
    ...
    public Observable<Boolean> request(final String... permissions) {
        return Observable.just("").compose(ensure(permissions));
    }
    ...
    public Observable<Permission> requestEach(final String... permissions) {
        return Observable.just("").compose(ensureEach(permissions));
    }
